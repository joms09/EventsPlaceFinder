...
class EventShoots : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ref = FirebaseDatabase.getInstance().getReference("event").orderByChild("eventtype").equalTo("Shoots")
    ...
    fun firebaseData() {
        ...
        val firebaseRecyclerAdapter = object : FirebaseRecyclerAdapter<Model, MyViewHolder>(option) {
            override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
                val itemView = LayoutInflater.from(this@EventShoots).inflate(R.layout.card_view, parent, false)
                        ...
                        if (status == "Verified") {
                            ...
                            holder.img_vet.setOnClickListener {
                                ...
                                event.child("count").setValue(model.Count + 1).addOnCompleteListener {
                                    val intent = Intent(this@EventShoots, SoloDetails::class.java)
